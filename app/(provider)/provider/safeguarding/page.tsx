...
export const metadata: Metadata = {
  title: "Safeguarding - Care Provider",
};
...
export default async function ProviderSafeguardingPage({
  searchParams,
}: PageProps) {
  ...
  return (
    <section className="mx-auto max-w-2xl">
      ...
      <p className="mt-1 text-ink-muted">
        As a care provider, you have a duty to report any safeguarding concerns.
      ...
      <div className="mt-4 rounded-xl border border-border bg-surface p-4 text-sm text-ink-muted">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>You suspect a person receiving care is being abused or neglected</li>
          <li>You witness unsafe practices by another provider</li>
          <li>A person discloses abuse or harm to you</li>
          <li>You observe signs of self-neglect or deterioration</li>
        </ul>
      </div>
